...
RANDOM_EVENTS = {
    ...
    -- ═══════════════════════════════════════════════════
    -- Batch 2: 幽默事件扩充 (20+ 新事件)
    -- 主题：非洲网吧日常、NPC联动、装饰联动、章节专属
    -- ═══════════════════════════════════════════════════
    ...
    -- #1 WiFi哲学家
    {
      ...
      emoji = "🧠",
      type = "auto",
      text = "一个穿着西装的中年人走进来，不用电脑，只是坐在WiFi信号最强的位置冥想。\n\n他说：'我不是来上网的，我是来感受电磁波的。据说5G能开悟。'\n\n其他客人投来迷惑的目光。他坐了三小时，付了双倍钱，然后飘然离去，留下一句：\n\n'谢谢，今天的WiFi特别有禅意。'\n\n💰+$30 声望+5（因为奇人奇事传开了）",
      effect = function()
          playerData_.money = playerData_.money + 30
          playerData_.reputation = playerData_.reputation + 5
      end,
      cond = function() return playerData_.day >= 3 and math.random(1, 100) <= 12 end,
    },
    ...
    -- #2 表情包战争
    {
      ...
      emoji = "😂",
      type = "choice",
      text = "两桌客人因为一个表情包的含义吵了起来。\n\nA桌说🙂是友好微笑，B桌坚持说🙂是阴阳怪气。\n\n争论越来越激烈，其他客人开始站队，整个网吧分成了两派。",
      choices = {
          { text = "📱 发起全店投票，让民主裁决", result = "你在白板上画了🙂，让所有客人投票。\n\n结果：友好派37票，阴阳派38票。\n\n但B桌的票多了3张——他去厕所的时候偷偷加的。被发现后全场哄笑，争论反而化解了。\n\n'好吧好吧，下次用😊就不会有歧义了。'\n\n客户满意度+10",
            effect = function()
                playerData_.reputation = playerData_.reputation + 10
            end },
          { text = "🔇 断他们两桌的网", result = "你悄悄把A桌B桌的网速降到1kb/s。\n\n两分钟后他们就忘了表情包的事，开始一起骂网速慢。\n\n'老板！这网怎么回事！'\n'可能是天气原因吧…'\n\n团结就是力量（虽然方向不太对）。\n\n声望-3 但避免了更大冲突",
            effect = function()
                playerData_.reputation = playerData_.reputation - 3
            end },
      },
      cond = function() return playerData_.day >= 5 and math.random(1, 100) <= 10 end,
    },
    ...
    -- #3 矿泉水危机
    {
      ...
      emoji = "💧",
      type = "choice",
      text = "供水管道破裂！整条街断水了。\n\n你的网吧还剩最后5瓶矿泉水，但门口排着20个渴得不行的路人。\n\n旁边杂货店趁机把水卖到$10一瓶。",
      choices = {
          { text = "🆓 免费分给路人（好名声）", result = "你把5瓶水切成小杯分给了20个人。虽然每人只有一小口，但大家感动得不行。\n\n'这老板是好人啊！以后就来他家上网！'\n\n当天下午水管修好后，来了12个新客人。\n\n💰+$60 声望+25",
            effect = function()
                playerData_.money = playerData_.money + 60
                playerData_.reputation = playerData_.reputation + 25
            end },
          { text = "💰 $5一瓶，合理定价", result = "你以$5一瓶出售——比杂货店便宜一半，但还是有人嘀咕'趁火打劫'。\n\n赚了$25，但有两个老客人说'看清你了'。\n\n💰+$25 声望-10",
            effect = function()
                playerData_.money = playerData_.money + 25
                playerData_.reputation = playerData_.reputation - 10
            end },
      },
      cond = function() return playerData_.day >= 8 and math.random(1, 100) <= 8 end,
    },
    ...
    -- #4 神秘代码
    {
      ...
      emoji = "💻",
      type = "auto",
      text = "一个戴墨镜的年轻人在3号机敲了6小时代码，屏幕全是绿色字符。\n\n你偷瞄了一眼——好像是在写一个'自动抢红包'脚本。\n\n他走的时候留了$50小费和一张纸条：'如果有人来找我，你什么都没看到。'\n\n你完全不知道发生了什么，但钱是真的。\n\n💰+$50",
      effect = function()
          playerData_.money = playerData_.money + 50
      end,
      cond = function() return playerData_.day >= 10 and math.random(1, 100) <= 7 end,
    },
    ...
    -- #5 非洲大叔学视频剪辑
    {
      ...
      emoji = "🎬",
      type = "auto",
      text = "一个60岁的大叔说他想学视频剪辑，要给孙子做生日视频。\n\n他花了4个小时，把所有特效都加了一遍：闪电、爆炸、彩虹、飞天、下雨、地震……\n\n最后成品1分钟，特效43种。孙子收到视频哭了——被吓哭的。\n\n大叔很满意：'这就是专业！'\n\n他预约了下周继续来做'圣诞特辑'。\n\n💰+$20 声望+8",
      effect = function()
          playerData_.money = playerData_.money + 20
          playerData_.reputation = playerData_.reputation + 8
      end,
      cond = function() return playerData_.day >= 4 and math.random(1, 100) <= 11 end,
    },
    ...
    -- #6 电竞选手来踢馆
    {
      ...
      emoji = "🎮",
      type = "choice",
      text = "一个自称'拉各斯闪电'的年轻人冲进来：\n\n'听说你们这有高手？我要挑战你们最强的人！输了我请全场喝汽水！'\n\n网吧里最强的客人'老鼠哥'抬了抬眼皮。",
      choices = {
          { text = "🏆 安排比赛！收门票", result = function()
              if math.random(1, 100) <= 55 then
                  return "'老鼠哥'只用了一只手就赢了。'拉各斯闪电'当场跪下拜师。\n\n围观群众欢呼雀跃，汽水钱到手！你顺手卖了12杯茶。\n\n💰+$80 声望+15"
              else
                  return "'拉各斯闪电'名不虚传，三局两胜击败了'老鼠哥'。\n\n但他很讲信用，还是请了全场汽水。临走时说：'你们这网吧不错，我会常来。'\n\n获得一个忠实客户！\n\n💰+$40 声望+20"
              end
          end,
            effect = function()
                if math.random(1, 100) <= 55 then
          ...
          { text = "🙅 别闹，这是网吧不是擂台", result = "'拉各斯闪电'很失望地走了。\n\n但'老鼠哥'小声说：'其实我今天状态不好，你帮了我一个忙。'\n\n他多坐了两小时，算是回报。\n\n💰+$15",
            effect = function()
                playerData_.money = playerData_.money + 15
            end },
      },
      cond = function() return playerData_.day >= 12 and math.random(1, 100) <= 9 end,
    },
    ...
    -- #7 蟑螂赛跑
    {
      ...
      emoji = "🪳",
      type = "auto",
      text = "深夜打扫时发现三只巨大的蟑螂在地板上赛跑。\n\n几个通宵的客人兴奋地开始下注：\n'我赌左边那只！它触须更长，空气动力学更好！'\n\n最后中间那只赢了——因为它直接飞起来了。所有人尖叫。\n\n但不知为什么，第二天来了好多客人说要看'蟑螂德比第二季'。\n\n💰+$25 声望+5（虽然方向有点奇怪）",
      effect = function()
          playerData_.money = playerData_.money + 25
          playerData_.reputation = playerData_.reputation + 5
      end,
      cond = function() return playerData_.day >= 6 and math.random(1, 100) <= 8 end,
    },
    ...
    -- #8 假装工作的人
    {
      ...
      emoji = "👔",
      type = "auto",
      text = "有个穿西装的白领每天早上9点准时来，开一个Excel表格，然后偷偷打游戏到下午5点。\n\n你装作没看见。直到有一天他老婆突然来了：'亲爱的，你同事说你不在办公室？'\n\n他面不改色：'我在远程办公，这是协作空间。'\n\n老婆看了看你的网吧招牌，半信半疑地走了。\n\n他给了你$20封口费和一个感激的眼神。\n\n💰+$20",
      effect = function()
          playerData_.money = playerData_.money + 20
      end,
      cond = function() return playerData_.day >= 5 and math.random(1, 100) <= 10 end,
    ...
    -- #9 网速祈祷仪式
    {
      ...
      emoji = "🙏",
      type = "auto",
      text = "WiFi突然变慢了。一个客人站起来，举起手机对着路由器念念有词：\n\n'Oh great router, I beseech thee, grant me 5G speeds…'\n\n其他客人纷纷加入，十个人围着路由器祈祷。\n\n巧合的是，隔壁施工队刚好修完了光缆。网速恢复的那一刻，全场欢呼：'神迹！'\n\n声望+10（你的路由器现在有了宗教地位）",
      effect = function()
          playerData_.reputation = playerData_.reputation + 10
      end,
      cond = function() return playerData_.day >= 4 and math.random(1, 100) <= 10 end,
    },
    ...
    -- #10 猫咪入侵
    {
      ...
      emoji = "🐱",
      type = "choice",
      text = "一只橘猫不知从哪钻进来，直接跳上了键盘。\n\n它在一个客人的游戏里打出了一串乱码——竟然触发了隐藏关卡。\n\n'这猫是高手！'客人惊呼。\n\n橘猫舔了舔爪子，一脸傲慢。",
      choices = {
          { text = "🐱 收养它当网吧吉祥物", result = "你在角落给橘猫铺了个窝。它每天趴在最贵的电脑旁边，客人们排队来'沾猫气'。\n\n有人说摸完它打游戏手感好了。虽然是迷信，但客流量确实涨了。\n\n💰+$15/天 声望+15\n\n（网吧新名片：有猫的网吧）",
            effect = function()
                playerData_.money = playerData_.money + 15
                playerData_.reputation = playerData_.reputation + 15
                playerData_._hasCafeCat = true
            end },
          { text = "🚪 温柔地请它出去", result = "你打开门想请猫出去，但它看了你一眼，那眼神仿佛在说：'你确定？'\n\n你确定了。它优雅地走了出去。\n\n第二天有3个客人问：'听说你们这有只会打游戏的猫？'\n\n'……它昨天走了。'\n\n声望-5（失去了一个营销机会）",
            effect = function()
                playerData_.reputation = playerData_.reputation - 5
            end },
      },
      cond = function() return playerData_.day >= 6 and math.random(1, 100) <= 9 end,
    },
    ...
    -- #11 停电音乐会
    {
      ...
      emoji = "🎵",
      type = "auto",
      text = "又停电了。正当所有人抱怨的时候，角落的客人掏出了一把尤克里里。\n\n'既然没网了，来个现场演出吧！'\n\n他唱了首改编的《Hotel California》——《Hotel Internet Café》：\n'You can check out any time you like, but you can never leave~'\n\n全场跟着唱，停电的40分钟反而成了最快乐的时光。\n\n三个路过的人被歌声吸引进来，等来电后成了新客人。\n\n💰+$35 声望+12",
      effect = function()
          playerData_.money = playerData_.money + 35
          playerData_.reputation = playerData_.reputation + 12
      end,
      cond = function() return playerData_.day >= 7 and math.random(1, 100) <= 8 end,
    },
    ...
    -- #12 家长突袭
    {
      ...
      emoji = "👩‍👦",
      type = "choice",
      text = "一位愤怒的妈妈冲进来：'我儿子是不是在这里？！他说去图书馆了！'\n\n你瞥了一眼5号机——那个小伙子正疯狂地试图最小化游戏窗口。",
      choices = {
          { text = "🤫 '没见过这个人'（掩护客人）", result = "你面不改色：'太太，这里只有正在做PPT的上班族。'\n\n那个小伙子机智地打开了一个百科网页。\n\n妈妈将信将疑地走了。小伙子擦了擦汗：'老板你救了我一命！'\n\n他以后每次来都多付$5'保护费'。\n\n💰+$5 声望-3（如果那妈妈发现了你就完了）",
            effect = function()
                playerData_.money = playerData_.money + 5
                playerData_.reputation = playerData_.reputation - 3
            end },
          { text = "👉 '5号机那位'（正义执行）", result = "你默默指了指5号机。\n\n妈妈拎着儿子耳朵离开了。临走前回头：'谢谢你，老板。你是个好人。'\n\n那小伙子用幽怨的眼神看着你。但第二天，他带着三个'图书馆学习小组'的同学来了。\n\n'妈妈说可以来这做作业。'\n\n💰+$30 声望+8",
            effect = function()
                playerData_.money = playerData_.money + 30
                playerData_.reputation = playerData_.reputation + 8
            end },
    ...
    -- #13 外卖大战
    {
      ...
      emoji = "🍕",
      type = "auto",
      text = "三个外卖小哥同时到达，都说自己先到的。\n\n他们在门口吵了起来，客人们纷纷探头看热闹。\n\n你出去调解，结果发现三个外卖都是同一桌客人点的——他同时在三个平台下了单。\n\n'我就想看看哪个最快嘛…'\n\n那人不好意思地全都收了，分了两份给旁边的客人。\n\n全场气氛莫名其妙地好了起来。\n\n声望+8",
      effect = function()
          playerData_.reputation = playerData_.reputation + 8
      end,
      cond = function() return playerData_.day >= 5 and math.random(1, 100) <= 10 end,
    ...
    -- #14 键盘ASMR
    {
      ...
      emoji = "⌨️",
      type = "auto",
      text = "深夜，网吧里只剩3个客人，异常安静。\n\n突然有人开始以极其有节奏感的方式敲键盘——哒哒哒，哒哒哒哒，哒……\n\n另外两人被催眠般地闭上了眼睛。一个还轻声说：'别停……'\n\n你偷偷录了一段发到网上，标题是'非洲网吧键盘ASMR'。\n\n获得了47个点赞。不算多，但也是一种成功。\n\n声望+5",
      effect = function()
          playerData_.reputation = playerData_.reputation + 5
      end,
      cond = function() return playerData_.day >= 8 and math.random(1, 100) <= 9 end,
    },
    ...
    -- #15 电脑中毒（物理意义）
    {
      ...
      emoji = "🦎",
      type = "choice",
      text = "2号机突然黑屏了。你打开机箱一看——一只壁虎住在里面，把线咬断了。\n\n它还带着一窝蛋。\n\n客人们围过来：'哇，这就是传说中的电脑病毒（物理版）！'",
      choices = {
          { text = "🏠 给壁虎搬家到后院", result = "你小心翼翼地把壁虎一家迁移到后院的墙缝里。\n\n修电脑花了$30，但这个故事在网上传开了——'非洲网吧发现主板壁虎'。\n\n莫名其妙多了一些好奇的客人。\n\n💰-$30 声望+20",
            effect = function()
                playerData_.money = playerData_.money - 30
                playerData_.reputation = playerData_.reputation + 20
            end },
          { text = "🤷 封住机箱缝隙（预防为主）", result = "你用胶带把所有机箱的缝隙都封住了。壁虎一家被温柔地请走。\n\n修电脑花了$30。至少以后不会再有爬虫入侵了。\n\n💰-$30 但后续维修费减少",
            effect = function()
                playerData_.money = playerData_.money - 30
            end },
      },
    ...
    -- #16 假币风波
    {
      ...
      emoji = "💸",
      type = "choice",
      text = "收银时发现一张可疑的钞票——摸起来手感不对。\n\n你拿起来对着灯看了看。旁边的客人紧张地盯着你。\n\n'那个……我也不确定是不是真的，路边摊找给我的……'",
      choices = {
          { text = "🔍 '你去银行验一下吧'", result = "你把钞票还给了他：'去银行验验，我不收不确定的钱。'\n\n他讪讪地走了。第二天带着新钞票来了：'验过了，确实是假的。谢谢你没报警。'\n\n他成了你最忠实的客人之一。\n\n声望+10",
            effect = function()
                playerData_.reputation = playerData_.reputation + 10
            end },
          { text = "😤 '算了这次我认了'", result = "你收了那张可疑的钞票，客人松了口气走了。\n\n后来你拿到银行一验——果然是假的。$20打水漂了。\n\n但在这条街上，你'好说话'的名声传开了。有人说这是优点，有人说这是弱点。\n\n💰-$20 声望+5",
            effect = function()
                playerData_.money = playerData_.money - 20
                playerData_.reputation = playerData_.reputation + 5
            end },
    ...
    -- #17 网红打卡
    {
      ...
      emoji = "📸",
      type = "auto",
      text = "一个拿着环形灯的女孩走进来：'这里好有复古感！我要拍个vlog！'\n\n她在你的网吧各种角度自拍了一小时，还把你的旧CRT显示器称为'Y2K美学'。\n\n'各位宝宝，这就是非洲最有氛围感的网吧，给我点赞！'\n\n视频获得了2000播放量。当天下午来了8个举着手机的年轻人。\n\n💰+$50 声望+20",
      effect = function()
          playerData_.money = playerData_.money + 50
          playerData_.reputation = playerData_.reputation + 20
      end,
    ...
    -- #18 午睡充电站
    {
      ...
      emoji = "😴",
      type = "choice",
      text = "中午时分，有5个客人都趴在键盘上睡着了。\n\n网吧瞬间安静得像图书馆。新客人进来一看：'这是网吧还是午睡房？'\n\n其中一个客人梦话说：'别推我的水晶……'",
      choices = {
          { text = "😴 推出'午休套餐'——上网+小睡$15", result = "你灵机一动，在门口挂了个牌子：'午休套餐：2小时上网+1小时午睡=$15'\n\n没想到附近的上班族疯狂涌入。中午时段收入直接翻倍。\n\n你甚至买了几个颈枕放在座位上。\n\n💰+$60 声望+10 \n\n（新商业模式解锁：网吧+午休房）",
            effect = function()
                playerData_.money = playerData_.money + 60
                playerData_.reputation = playerData_.reputation + 10
            end },
          { text = "⏰ 叫醒他们，网吧不是宿舍", result = "你挨个拍醒了他们：'醒醒！计时呢！'\n\n他们迷迷糊糊地揉眼睛：'啊？赢了吗？'\n\n没赢，但时间在流逝，钱也在流逝。他们乖乖继续上网了。\n\n（正常运营，不赚不亏）",
            effect = function() end },
      },
      cond = function() return playerData_.day >= 7 and math.random(1, 100) <= 9 end,
    },
    ...
    -- #19 密码泄露恐慌
    {
      ...
      emoji = "🔐",
      type = "auto",
      text = "一个客人大喊：'我密码被盗了！！肯定是你们网吧的网有问题！'\n\n全场恐慌。有人开始疯狂改密码，有人直接拔网线，还有人问你'网吧有没有加密'。\n\n你检查了一下——原来是他自己在公共电脑上勾选了'记住密码'。\n\n你帮他清除了缓存，顺便给所有人做了一个3分钟的网络安全讲座。\n\n'记住：公共电脑永远不要点记住密码！'\n\n全场鼓掌。你获得了'网安老师'的外号。\n\n声望+15",
      effect = function()
          playerData_.reputation = playerData_.reputation + 15
      end,
      cond = function() return playerData_.day >= 9 and math.random(1, 100) <= 8 end,
    ...
    -- #20 跨国恋情
    {
      ...
      emoji = "💕",
      type = "auto",
      text = "一个害羞的小伙子每天来视频通话3小时。对面是一个金发碧眼的外国女孩。\n\n他总是穿他最好的衬衫来，还喷了香水。\n\n今天他激动地跑来：'她答应来看我了！从挪威来！'\n\n全网吧的人都鼓掌。老客人们纷纷出主意：'带她去看落日！''做你妈妈的花生汤！'\n\n你默默给他打了个八折——为了爱情。\n\n💰-$5 声望+10 心情+5",
      effect = function()
          playerData_.money = playerData_.money - 5
          playerData_.reputation = playerData_.reputation + 10
          for _, m in ipairs(teamMembers_ or {}) do m.mood = math.min(100, m.mood + 5) end
      end,
      cond = function() return playerData_.day >= 12 and math.random(1, 100) <= 7 end,
    },
    ...
    -- #21 打印机复仇
    {
      ...
      emoji = "🖨️",
      type = "auto",
      text = "网吧的旧打印机终于报废了——以一种壮烈的方式。\n\n它在最后一次打印中，把墨水喷了客人一脸。整张脸变成了青蓝色。\n\n客人呆住了。其他人也呆住了。然后全场爆笑。\n\n'我看起来像阿凡达吗？'\n'更像蓝精灵。'\n\n你赔了他$20洗衣费和一杯免费的茶。这个故事被客人们讲了一个月。\n\n💰-$20 声望+8",
      effect = function()
          playerData_.money = playerData_.money - 20
          playerData_.reputation = playerData_.reputation + 8
      end,
    ...
    -- #22 哲学辩论赛
    {
      ...
      emoji = "🤔",
      type = "auto",
      text = "凌晨2点，仅剩的3个通宵客人展开了一场激烈辩论：\n\n'如果网速无限快，你能在一瞬间下载完整个互联网吗？'\n'那你的硬盘装得下吗？'\n'如果硬盘也无限大呢？'\n'那就不是硬盘了，那是宇宙。'\n'所以……互联网就是另一个宇宙？'\n\n他们辩论到天亮。你在旁边听着，觉得自己的网吧仿佛成了苏格拉底的广场。\n\n声望+5（你的网吧有思想深度）",
      effect = function()
          playerData_.reputation = playerData_.reputation + 5
      end,
      cond = function() return playerData_.day >= 10 and math.random(1, 100) <= 8 end,
    ...
    -- #23 手机充电帝国
    {
      ...
      emoji = "🔋",
      type = "choice",
      text = "最近越来越多人来你网吧不是为了上网——而是为了充电。\n\n'老板，借个插头呗？就充一下就走。'\n\n今天同时有8个人在蹭电，但只有2个在上网。",
      choices = {
          { text = "⚡ 开设充电服务：$2/小时", result = "你在门口立了个牌子：'充电服务 $2/小时 含免费WiFi'\n\n效果出奇的好！很多人充着电就开始刷手机，然后觉得手机屏幕太小，就去上了电脑。\n\n充电服务反而带动了上机率。商业天才！\n\n💰+$40 声望+8",
            effect = function()
                playerData_.money = playerData_.money + 40
                playerData_.reputation = playerData_.reputation + 8
            end },
          { text = "🚫 插头只给上网客人用", result = "你贴了个规矩：'充电仅限上网客人'。\n\n蹭电的人少了，但有些人嘀咕你小气。\n\n'隔壁的杂货店都让免费充……'\n\n声望-5 但电费省了",
            effect = function()
                playerData_.reputation = playerData_.reputation - 5
    ...
    -- #24 AI画像事件（章节3+专属）
    {
      ...
      emoji = "🎨",
      type = "choice",
      text = "一个客人发现了AI画画网站，开始帮全网吧的人生成肖像。\n\n'来来来，免费帮你画！输入描述就行！'\n\n结果生成的图都很离谱——有人变成了肌肉猛男，有人变成了动漫萝莉。\n\n全场笑成一团。有人甚至想把AI肖像当头像用。",
      choices = {
          { text = "💡 推出'AI肖像'服务：$3/张", result = "你趁热打铁开了个'AI肖像'服务。客人们排队来生成自己的'理想形象'。\n\n最受欢迎的prompt是'非洲超级英雄版的我'。\n\n今天额外赚了$45。这个时代真好。\n\n💰+$45 声望+10",
            effect = function()
                playerData_.money = playerData_.money + 45
                playerData_.reputation = playerData_.reputation + 10
            end },
          { text = "😂 加入他们，给自己也画一张", result = "你输入了'英俊的网吧老板，站在金色宫殿前'。\n\nAI生成了一个穿盔甲的你——骑着一台巨大的路由器。\n\n全场鼓掌：'老板威武！'\n\n你把图片打印出来贴在了收银台。\n\n声望+8 心情+10",
            effect = function()
                playerData_.reputation = playerData_.reputation + 8
                for _, m in ipairs(teamMembers_ or {}) do m.mood = math.min(100, m.mood + 10) end
            end },
      },
      cond = function()
          local ChapterSystem = require("ChapterSystem")
          return playerData_.day >= 15 and ChapterSystem.IsUnlocked("npc_advanced") and math.random(1, 100) <= 8
      end,
    },
    ...
    -- #25 神秘大客户（章节4+专属）
    {
      ...
      emoji = "🕶️",
      type = "choice",
      text = "一辆黑色SUV停在门口。下来一个带保镖的人，进门说：\n\n'我需要包场2小时。所有人请出去。费用不是问题。'\n\n其他客人面面相觑。",
      choices = {
          { text = "💰 接受！$200包场费", result = "你清场了。那人坐下后，戴上耳机开始……看猫咪视频。\n\n两个小时，全是猫咪视频。\n\n离开时他说：'在办公室不好意思看这些。谢谢你的配合。'\n\n他留了$200。你对人生有了新的理解。\n\n💰+$200 声望+15",
            effect = function()
                playerData_.money = playerData_.money + 200
                playerData_.reputation = playerData_.reputation + 15
            end },
          { text = "🙅 '不好意思，我不清场'", result = "'我不赶客人，但可以给你最好的VIP位置。'\n\n那人想了想：'行吧。'\n\n他在VIP位坐了2小时，付了正常价格。保镖站在旁边一动不动，吓得旁边客人键盘都不敢敲响。\n\n💰+$30 但今天营业额因为气氛原因少了$20\n\n💰+$10",
            effect = function()
                playerData_.money = playerData_.money + 10
            end },
      },
      cond = function()
          local ChapterSystem = require("ChapterSystem")
          return playerData_.day >= 20 and ChapterSystem.IsUnlocked("elite_events") and math.random(1, 100) <= 6
      end,
    },
}
