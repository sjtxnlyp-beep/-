...
SCENE_IMAGES = {
    ...
    -- 网吧经营状态场景图（v3 - 宽幅横向像素风插画）
    cafe_empty      = "image/cafe_few_20260525095009.png",
    cafe_few        = "image/cafe_few_20260525095009.png",
    cafe_normal     = "image/cafe_normal_20260525094846.png",
    cafe_busy       = "image/cafe_busy_20260525094853.png",
    cafe_blackout   = "image/cafe_blackout_20260525094850.png",
    cafe_tournament = "image/cafe_full_20260525094846.png",
    cafe_bbq        = "image/cafe_busy_20260525094853.png",
    cafe_streaming  = "image/cafe_full_20260525094846.png",
    -- 夜间/包夜变体
    cafe_few_night    = "image/cafe_few_night_20260525094846.png",
    cafe_normal_night = "image/cafe_night_20260525094849.png",
    cafe_busy_night   = "image/cafe_full_night_20260525094926.png",
    cafe_overnight    = "image/cafe_full_night_20260525094926.png",
}
...
pendingDaySummary_ = nil        -- P0-2 征途小结弹窗 {day, income, netIncome, tip}
...
function GetWeatherLabel()
    ...
    -- 旱季(前10天偏多)，雨季(后期偏多)
    if day <= 5 then
        return "☀️", { 230, 160, 60, 255 }, "Dry"
    elseif day <= 10 then
        return "🔥", { 230, 100, 50, 255 }, "Hot"
    elseif day <= 15 then
        return "🌧️", { 100, 170, 230, 255 }, "Rain"
    else
        return "⛈️", { 160, 130, 200, 255 }, "Storm"
    end
end
