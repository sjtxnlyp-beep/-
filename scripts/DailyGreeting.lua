...
function DailyGreeting.Generate()
    ...
    -- 感情线问候优先（40%概率，需要 RomanceSystem 且有激活的感情线）
    if RomanceSystem and RomanceSystem.GetRomanceGreeting then
        local romGreet = RomanceSystem.GetRomanceGreeting()
        if romGreet and math.random() < 0.40 then
